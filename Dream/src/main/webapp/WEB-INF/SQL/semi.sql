...
select*
from tbl_member_login;
where userid ='ggoma003@naver.com';



select *
from tbl_product
where product_name = '진영이테스트상품2';

commit;

delete from tbl_product
where product_num = '1003';

update tbl_product set product_image = '무드등1.PNG'
where product_name = '수면유도 무드등';

commit;

delete tbl_buylist
where order_num between 693 and 695;
